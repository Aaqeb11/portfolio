...
const ComponentDock = () => {
  const setupTimeData = [
    { task: "Manual Setup", hours: 8 },
    { task: "Component Dock", hours: 0.5 },
  ];
    ...
    <div className="min-h-screen bg-[##0a0a0a]">
      ...
      <header className="border-b border-border/50 bg-gradient-to-b from-[##0a0a0a] to-[#141414]/30">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-[#262626]-[#ccf5f5] hover:text-[#ccf5f5] transition-colors mb-6"
          >
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-[#262626]-[#ccf5f5]">
